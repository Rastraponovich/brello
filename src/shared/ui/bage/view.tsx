...
const _Bage = forwardRef<HTMLDivElement, BageProps>((props, ref) => {
  const { size = "md", caption, variant = "standard", color = "blue" } = props;
  ...
  return (
    ...
    >
      {variant && variant === "dot" && (
        <i data-qa="Bage-dotIcon" className={cx("h-2 w-2 rounded-full", BAGE_DOT_DICT[color])} />
      )}
