...
import { BaseButtonGroupAction, ButtonsGroupProps } from "./model";

type BaseGroupButton = VariantProps<typeof baseGroupButton>;

interface IBaseGroupButton extends Omit<BaseButtonGroupAction, "id">, BaseGroupButton {
  foo?: "bar";
}
...
const _ButtonGroups = forwardRef<HTMLDivElement, ButtonsGroupProps>(
  ({ variant = "text", fullWidth = false }, ref) => {
    const actions: BaseButtonGroupAction[] = [
      {
        id: 1,
        text: "preved",
        icon: "common/plus",
...
export const ButtonsGroup = memo<ButtonsGroupProps>(_ButtonGroups);
