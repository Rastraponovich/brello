...
import type { FeaturedIconCircleVariant, FeaturedIconSquareVariant } from "./model";
...
type TColorsConditional<
  T,
  S extends string = T extends FeaturedIconCircleVariant
    ? FeaturedIconCircleVariant
    : FeaturedIconSquareVariant,
> = Record<S, T extends FeaturedIconCircleVariant ? Record<EFeaturedIconColor, string> : string>;

export const SQUARE_COLORS: TColorsConditional<FeaturedIconSquareVariant> = {
...
export const CIRCLE_COLORS: TColorsConditional<FeaturedIconCircleVariant> = {
